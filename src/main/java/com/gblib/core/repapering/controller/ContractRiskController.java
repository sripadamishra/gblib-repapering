...
public class ContractRiskController {
	...
	@RequestMapping(value = "/find/contractrisk", method = RequestMethod.POST)
	public @ResponseBody List<ContractRisk> getContractRiskDetails(@RequestBody int contractId) {
